...
//////////////////////////////////////////////////////////////////
// Script Purpose: Represents attack action of Ravager type of enemy.
//////////////////////////////////////////////////////////////////

namespace Hellcrown.AI
{
    public class RavagerAttackAction : GOAPAction
    {
        /// <summary>
        ...
        /// Constructor.
        /// </summary>
        public RavagerAttackAction() : base()
        {
            AddEffect(RavagerGoalStateKeys.AttackPlayer, true);
